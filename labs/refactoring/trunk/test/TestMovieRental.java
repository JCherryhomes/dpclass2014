...
public class TestMovieRental {
    ...
    public void test1() {
        ...
        // Added some checks to verify each value
        assertThat(M1.getCharge(5), IsEqual.equalTo(15.0));
        assertThat(M3.getCharge(4), IsEqual.equalTo(3.0));
        assertThat(M2.getCharge(3), IsEqual.equalTo(3.5));
        assertThat(C1.getTotalCharges(), IsEqual.equalTo(21.5));
        assertTrue(ans + " : " + C1.statement(), ans.equals(C1.statement()));
    }
    ...
    public void test2() {
        ...
        // Added some checks to verify each value
        assertThat(M1.getCharge(1), IsEqual.equalTo(3.0));
        assertThat(M3.getCharge(8), IsEqual.equalTo(9.0));
    ...
    public void test3() {
        ...
        // Added some checks to verify each value
        assertThat(M2.getCharge(2), IsEqual.equalTo(2.0));
        assertThat(M3.getCharge(1), IsEqual.equalTo(1.5));
